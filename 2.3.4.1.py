...
def double_s_aes_encrypt(plaintext, key):
    ...
    key2 = key & 0x0000FFFF
    intermediate = s_aes_encrypt(plaintext, key1)
    ciphertext = s_aes_encrypt(intermediate, key2)
    return ciphertext
...
def double_s_aes_decrypt(ciphertext, key):
    key1 = (key & 0xFFFF0000) >> 16
    key2 = key & 0x0000FFFF
    intermediate = s_aes_decrypt(ciphertext, key2)
    plaintext = s_aes_decrypt(intermediate, key1)
    return plaintext
